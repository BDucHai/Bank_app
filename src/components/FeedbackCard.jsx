...
const FeedbackCard = ({ content, name, title, img }) => (
    <div className="flex md:justify-between justify-center flex-col px-10 py-12 rounded-[20px] min-h-[395px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
