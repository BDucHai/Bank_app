    ...
    <section id="home" class={`flex md:flex-row flex-col ${styles.paddingY}`}>
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 md:px-16 px-6`}>
            ...
            <div className="flex flex-row justify-between items-center w-full">
                <h1 className="flex-1 font-poppins text-white font-semibold sm:text-[72px] text-[52px] sm:leading-[100px] leading-[75px]">
            ...
            <h1 className="font-poppins text-white font-semibold sm:text-[68px] text-[52px] sm:leading-[100px] leading-[75px] w-full">
                Payment Method.
            </h1>
            <p className={`${styles.paragraph} font-poppins max-w-[470px] mt-6`}>
